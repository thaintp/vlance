	...
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		<div class="d-flex flex-column flex-root">
			<div class="d-flex flex-row flex-column-fluid page">
				<div class="aside aside-left d-flex aside-fixed pl-20" id="kt_aside">
											...
											<div class="card-body">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle">
														<img src="/images/assets/media/project-logos/3.png" alt="img" />
													</div>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" class="text-dark-75 text-hover-primary">Keenthemes</a>
							</div>
							<div class="nav nav-dark order-1 order-md-2">
								<a href="http://keenthemes.com/metronic" class="nav-link pr-3 pl-0">About</a>
								<a href="http://keenthemes.com/metronic" class="nav-link px-3">Team</a>
								<a href="http://keenthemes.com/metronic" class="nav-link pl-3 pr-0">Contact</a>
							</div>
						</div>
					</div>
				</div>

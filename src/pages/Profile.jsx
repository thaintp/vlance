...
const Profile = () => {
  ...
  useEffect(() => {
    JobService.get({ employer_id: id }).then((data) => setEJobs(data?.data));
    JobService.get({ freelancer_id: id }).then((data) => setFJobs(data?.data));
    account.id &&
      ReviewService.get({ user_id: id }).then((data) => setReviews(data?.data));
  }, [account]);
  return id || auth.account ? (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="/images/assets/plugins/global/plugins.bundle.css"
          rel="stylesheet"
          type="text/css"
        />
        <link
          href="/images/assets/plugins/custom/prismjs/prismjs.bundle.css"
          rel="stylesheet"
          type="text/css"
        />
        <link
          href="/images/assets/css/style.bundle.css"
          rel="stylesheet"
          type="text/css"
        />
        <link
          rel="shortcut icon"
          href="/images/assets/media/logos/favicon.ico"
        />
      </head>
      <body
        id="kt_body"
                        ...
                        <div class="d-flex mb-9">
                          <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
                            <div class="symbol symbol-50 symbol-lg-120">
                              <img
                                src="/images/assets/media/users/300_1.jpg"
                                alt="avatar"
                              />
                            </div>
                          ...
                          <div class="flex-grow-1">
                            <div class="d-flex justify-content-between flex-wrap mt-1">
                              <div class="d-flex mr-3">
                                ...
                                >
                                  {account.user_information?.fullname}
                                </a>
                                <a href="/#">
                              ...
                              <div class="my-lg-0 my-3">
                                ...
                                <a
                                  href="/#"
                                  class="btn btn-sm btn-light-info font-weight-bolder text-uppercase"
                                >
                                  hire
                                </a>
                              </div>
                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-1">
                              <div class="d-flex flex-column flex-grow-1 pr-8">
                                ...
                                <span class="font-weight-bold text-dark-50">
                                  {account.user_information?.bio}
                                </span>
                                <span class="font-weight-bold text-dark-50">
                                  {account.user_information?.experience}
                                </span>
                                <div>
                          ...
                          <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                              ...
                              <span class="font-weight-bolder font-size-h5">
                                ...
                                {toVND(account.user_information?.balance)}
                              </span>
                            </div>
                          </div>
                          <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                              ...
                              <span class="font-weight-bolder font-size-h5">
                                <span class="text-dark-50 font-weight-bold"></span>
                                {toVND(account.user_information?.hold_balance)}
                              </span>
                            </div>
                          </div>
                          <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                              ...
                              <span class="font-weight-bolder font-size-h5">
                                <span class="text-dark-50 font-weight-bold"></span>
                                {toVND(account.user_information?.earn_balance)}
                              </span>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                              <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                                ...
                                <li class="nav-item">
                                  <a
                                    class="btn py-2 px-4 btn-light-primary"
                                    data-toggle="tab"
                                        ...
                                        <td class="pl-0 py-4">
                                          <div class="symbol symbol-50 symbol-light">
                                            <span class="symbol-label">
                                              <img
                                                src="/images/assets/media/svg/misc/003-puzzle.svg"
                                        ...
                                        <tr key={job.id}>
                                          <td class="pl-0 py-4">
                                            <div class="symbol symbol-50 symbol-light mr-1">
                                              <span class="symbol-label">
                                                <img
                                                  src="/images/assets/media/svg/misc/006-plurk.svg"
                                                  class="h-50 align-self-center"
                                                  alt=""
                                                />
                                              </span>
